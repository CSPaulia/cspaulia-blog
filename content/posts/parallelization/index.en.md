...
<figure>
  <img src="../../../posts/parallelization/gpu-node-overview.png" alt="Hierarchy of a multi-GPU node">
...
<figure>
  <img src="../../../posts/parallelization/ranks.png" alt="Illustration of ranks">
...
<figure>
  <img src="../../../posts/parallelization/collective-operations-overview.png" alt="Overview of collective communication primitives">
...
<figure>
  <img src="../../../posts/parallelization/all-reduce-decomposition.png" alt="All-reduce decomposed into Reduce-scatter and All-gather">
...
<figure>
  <img src="../../../posts/parallelization/gpu-node-classic.webp" alt="Traditional multi-node GPU interconnect topology">
...
<figure>
  <img src="../../../posts/parallelization/tpu-gpu-networking.png" alt="Comparison of a TPU torus mesh and a switched GPU network">
...
<figure>
  <img src="../../../posts/parallelization/data-parallelism.png" alt="Illustration of data parallelism" width="50%">
...
<figure>
  <img src="../../../posts/parallelization/zero-state-sharding.png" alt="The three ZeRO stages shard parameters, gradients, and optimizer state differently">
...
<figure>
  <img src="../../../posts/parallelization/fsdp-operation-flow.png" alt="An FSDP unit aggregates parameters, computes, reduces gradients, and releases memory during forward and backward passes">
...
<figure>
  <img src="../../../posts/parallelization/fsdp-overlap-timeline.png" alt="FSDP timeline showing All-gather and Reduce-scatter overlapped with forward and backward computation">
...
<figure>
  <img src="../../../posts/parallelization/tensor-parallelism.png" alt="Illustration of tensor parallelism" width="50%">
...
<figure>
  <img src="../../../posts/parallelization/tensor-parallel-transformer-block.png" alt="Column and row parallelism in an MLP and self-attention" width="100%">
...
<figure>
  <img src="../../../posts/parallelization/tensor-parallel-scaling.png" alt="Tensor parallel degree versus per-GPU throughput for a 3B model" width="70%">
...
<figure>
  <img src="../../../posts/parallelization/sequence-parallelism.png" alt="Sequence parallelism and tensor parallelism alternate within a Transformer block" width="100%">
...
<figure>
  <img src="../../../posts/parallelization/context-parallel.png" alt="In context parallelism, query blocks stay local while key-value blocks circulate between devices">
...
<figure>
  <img src="../../../posts/parallelization/pipeline-parallelism.png" alt="Illustration of pipeline parallelism" width="50%">
...
<figure>
  <img src="../../../posts/parallelization/layer-wise-parallelism.png" alt="Four GPUs each handle consecutive model layers in a layer-wise split">
...
<figure>
  <img src="../../../posts/parallelization/layer-wise-utilization.png" alt="Stepped forward and backward execution with low utilization in a four-stage layer-wise split">
...
<figure>
  <img src="../../../posts/parallelization/pipeline-microbatches.png" alt="Forward and backward scheduling of four micro-batches in a four-stage pipeline">
...
<figure>
  <img src="../../../posts/parallelization/pipeline-batch-size-performance.png" alt="Pipeline-parallel scale and per-GPU throughput at different batch sizes">
...
<figure>
  <img src="../../../posts/parallelization/zero-bubble-schedules.png" alt="Comparison of standard 1F1B scheduling with two zero-bubble pipeline schedules">
...
<figure>
  <img src="../../../posts/parallelization/expert-parallelism-routing.png" alt="Expert parallelism places complete experts on different devices and routes tokens through two All-to-all operations" width="100%">
...
<figure>
  <img src="../../../posts/parallelization/moe-parallel-folding.png" alt="MoE Parallel Folding uses different parallel groups for attention and MoE layers" width="100%">
...
<figure>
  <img src="../../../posts/parallelization/llm-parallelism-comparison-table.png" alt="Comparison of LLM parallelization strategies in communication, memory, bandwidth, batch scaling, and ease of use" width="100%">
